  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Transaction is not found in the empty JSON string", Transaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Transaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("asset0").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `asset0` to be a primitive type in the JSON string but got `%s`", jsonObj.get("asset0").toString()));
      }
      if (!jsonObj.get("quantity0").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `quantity0` to be a primitive type in the JSON string but got `%s`", jsonObj.get("quantity0").toString()));
      }
      if (!jsonObj.get("quantity1").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `quantity1` to be a primitive type in the JSON string but got `%s`", jsonObj.get("quantity1").toString()));
      }
      if (!jsonObj.get("asset1").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `asset1` to be a primitive type in the JSON string but got `%s`", jsonObj.get("asset1").toString()));
      }
      ...
      if (!jsonObj.get("admin_user_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `admin_user_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("admin_user_id").toString()));
      }
